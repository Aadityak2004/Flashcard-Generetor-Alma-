...
const Error404 = () => {
    return (
        <div className=' flex flex-col justify-center items-center dark:text-white '>
            ...
            <p className='xl:w-1/3 w-[80%] font-bold my-1 text-sm xl:text-base'>The page you are looking for might have been removed had its name changed or is temporarily unavailable.</p>
